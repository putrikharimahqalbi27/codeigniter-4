<div class="col-md-12">
    ...
    <div class="card card-info">
        ...
        <?php
        echo form_open_multipart('Barang/SimpanData');
        ?>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-2">
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Gambar</label>
                            <img src="<?= base_url('gambar/blankfoto.jpg') ?>" id="gambar_load" class="img-fluid" width="200px" height="200px">
                        </div>
                    </div>
                    <div class="col-sm-12">
                ...
                <div class="col-sm-10">
                    <div class="form-group">
                        ...
                        <input class="form-control" name="kode_barang" value="<?= old('kode_barang') ?>" placeholder="Kode Barang">
                    </div>

                    <div class="form-group">
                        <label>Nama Barang</label>
                        <input class="form-control" name="nama_barang" value="<?= old('nama_barang') ?>" placeholder="Nama Barang">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Jumlah</label>
                        <input type="number" class="form-control" name="jumlah_barang" value="<?= old('jumlah_barang') ?>" placeholder="Jumlah Barang">
                    </div>
                </div>
            </div>
