    ...
    <div class="card card-outline card-info">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="<?= base_url('User/AddData') ?>" class="btn btn-info btn-flat btn-sm">
                    ...
                    foreach ($user as $value) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="<?= base_url('foto/' . $value['foto']) ?>" width="125px" height="160px" alt="Foto User">
                            </td>
                            <td class="text-center">
                                <?= $value['level'] == '0' ? '<span class="badge badge-success"> Admin </span>' : '<span class="badge badge-primary"> Petugas </span>' ?>
                            </td>
                            <td>
